...
@section('page-title')
<title>Admin Dashboard | Ecommerce Platform</title>
@endsection
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 row-cols-xl-4 g-3">
                <div class="col">
                    <div class="p-3 text-center border radius-10">
                        <span class="donut" data-peity='{ "fill": ["#5e72e4", "#f2f2f2"], "innerRadius": 50, "radius": 32 }'>4/5</span>
                ...
                <div class="col">
                    <div class="p-3 text-center border radius-10">
                        <span class="donut" data-peity='{ "fill": ["#ff2fa0", "#f2f2f2"], "innerRadius": 50, "radius": 32 }'>2/5</span>
                ...
                <div class="col">
                    <div class="p-3 text-center border radius-10">
                        <span class="donut" data-peity='{ "fill": ["#2dce89", "#f2f2f2"], "innerRadius": 50, "radius": 32 }'>3/5</span>
                ...
                <div class="col">
                    <div class="p-3 text-center border radius-10">
                        <span class="donut" data-peity='{ "fill": ["#fb6340", "#f2f2f2"], "innerRadius": 50, "radius": 32 }'>2/5</span>
