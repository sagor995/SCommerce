            ...
            <form action="{{route('category.update',$category->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            <label>Name:</label>
                            <input type="text" name="name" class="form-control" placeholder="Category Name" value="{{$category->name}}" autocomplete="off" required />
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            <label>Name:</label>
                            <textarea name="description" class="form-control" placeholder="Write Description" rows="5">{{$category->description}}</textarea>
                        </div>
                        <div class="mb-3">
