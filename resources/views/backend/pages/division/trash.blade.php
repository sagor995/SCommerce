...
@section('page-title')
<title>Manage All Division | Ecommerce Platform</title>
@endsection
        ...
        <div class="card-header">
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown options ms-auto">
                    <a href="{{route('disivion.manage')}}"><span class="btn btn-primary btn-sm">View Active Divisions</span></a>
                </div>
            </div>
        </div>
        <div class="card-body">
            @if($disivions->count()>0)
                ...
                <table class="table table-bordered table-striped table-hover table-border" id="bdata_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$i;}}</td>
                            <td>{{$division->name}}</td>
                            <td>{{$division->priority_number}}</td>
                            <td>
                            ...
                            <td>
                                <div class="action-bar">
                                    <ul>
                                        <li><a href="{{route('division.edit', $division->id)}}"><i class="lni lni-pencil-alt text-success"></i></a></li>
                                        <li><a href="" data-bs-toggle="modal" data-bs-target="#deleteDivision{{ $division->id }}"><i class="lni lni-trash text-danger"></i></a></li>
                                    </ul>
                                </div>
                            </td>
                            <!-- Modal -->
