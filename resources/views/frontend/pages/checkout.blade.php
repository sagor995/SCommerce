                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="email" name="email" id="email" value="{{ Auth::user()->email ? Auth::user()->email : '' }}" class="form-control" required readonly>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" name="address_line1" id="address_line1" placeholder="Address line 1" value="{{ Auth::user()->address_line1 ? Auth::user()->address_line1 : '' }}" class="form-control" required>
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label class="font-weight-bold text-dark text-2">Address Line 2 </label>
                                            <input type="text" name="address_line2" id="address_line2" placeholder="Address line 2" value="{{ Auth::user()->address_line2 ? Auth::user()->address_line2 : '' }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-lg-6">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select class="form-control" name="district_id" required>
                                                ...
                                                <option value="{{$district->id}}" @if($district->id == Auth::user()->district_id)
                                                    selected
                                                    @endif
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input class="form-control" type="text" name="country_name" id="country_name" value="{{ Auth::user()->country_name ? Auth::user()->country_name : '' }}" placeholder="Country Name" required>
                                        </div>
                                        <div class="form-group col-lg-6">
                                ...
                                <div class="card-body">
                                    <form action="/" id="frmShippingAddress" method="post">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col">
                                                <label class="font-weight-bold text-dark text-2">Email</label>
                                                <input type="email" name="email" id="email" value="{{ Auth::user()->email ? Auth::user()->email : '' }}" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col">
                                                <label class="font-weight-bold text-dark text-2">Address Line 1 </label>
                                                <input type="text" name="address_line1" id="address_line1" placeholder="Address line 1" value="{{ Auth::user()->address_line1 ? Auth::user()->address_line1 : '' }}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-lg-6">
                                                <label class="font-weight-bold text-dark text-2">Zip Code</label>
                                                <input class="form-control" type="text" name="zipCode" id="zipCode" value="{{ Auth::user()->zipCode ? Auth::user()->zipCode : '' }}" placeholder="Zip Code">
                                            </div>
                                            <div class="form-group col-lg-6">
                                                <label class="font-weight-bold text-dark text-2">Country</label>
                                                <input class="form-control" type="text" name="country_name" id="country_name" value="{{ Auth::user()->country_name ? Auth::user()->country_name : '' }}" placeholder="Country Name">
                                            </div>
                                        </div>
